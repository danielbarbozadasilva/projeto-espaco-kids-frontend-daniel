...
import { Button, FormGroup, Label, Input, FormFeedback, Spinner } from 'reactstrap'
...
const Perfil = () => {
  ...
  const buscarDadosUsuario = async () => {
    const formulario = await getServiceDetalhesUsuarios(perfil.id)
      ...
      <div className='colunasFormularios'>
        <div className='coluna1'>
          ...
          <FormGroup>
            ...
            <Input
              invalid={!!formValidate.nomeusuario} disabled={loading} type='text' id='nomeusuario' value={form.nomeusuario || ''} onChange={handleChange}
          ...
          <FormGroup>
            ...
            <Input
              invalid={!!formValidate.datanascimentoparticipante} disabled={loading} type='date' id='datanascimentoparticipante' value={form.datanascimentoparticipante ? moment(form.datanascimentoparticipante).format('YYYY/MM/DD').replaceAll('/', '-') : ''} onChange={handleChange}
          ...
          {!isAdmin
            ? (
              <FormGroup>
                ...
                <Input
                  invalid={!!formValidate.nomeparticipante} disabled={loading} type='text' id='nomeparticipante' value={form.nomeparticipante || ''} onChange={handleChange}
        ...
        <div className='coluna2'>
          <FormGroup>
            ...
            <Input
              invalid={!!formValidate.telefone} disabled={loading} type='text' id='telefone' value={form.telefone || ''} onChange={handleChange}
          ...
          <FormGroup>
            ...
            <Input
              invalid={!!formValidate.endereco} disabled={loading} type='text' id='endereco' value={form.endereco || ''} onChange={handleChange}
          ...
          <FormGroup>
            ...
            <Input
              invalid={!!formValidate.email} disabled={loading} type='email' id='email' value={form.email || ''} onChange={handleChange}
